                            ...
                            <article>
                                <?php if($sub === 'group'): ?>
                                    ...
                                    <header class="d-flex flex-wrap align-content-center">
                                        <button onclick="location.href='config/process/nav.proc.php?'"
                                            data-toggle="tooltip" title="Previous" class="btn p-0">
                                            <?php

                                                $add = 'assets/icons/sort_left.png';
                                                $addData = base64_encode(file_get_contents($add));
                                                $addSsrc = 'data: '.mime_content_type($add).';base64,'.$addData;
                                        ...
                                        <button onclick="location.href='config/process/nav.proc.php?'"
                                            data-toggle="tooltip" title="Next" class="btn p-0">
                                            <?php

                                                $add = 'assets/icons/sort_right.png';
                                                $addData = base64_encode(file_get_contents($add));
                                                $addSsrc = 'data: '.mime_content_type($add).';base64,'.$addData;
                                    ...
                                    <article>
                                        ...
                                        <div class="w-50 p-2">
                                            <!--ID-->
                                            <div class="row no-gutters mb-2 border-bottom">
                                                <div class="col-sm-4">
                                                    <strong>ID</strong>
                                                </div>
                                                <div class="col-sm-8">
                                                    <p class="m-0 pl-2">Group id</p>
                                                </div>
                                            </div>
                                            <!--DESCRIPTION-->
                                            <div class="row no-gutters border-bottom">
                                                ...
                                                <div class="col-sm-8">
                                                    <p class="m-0 pl-2">Group Description</p>
                                                </div>
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                        ...
                                        <form class="w-50 p-2">
                                            ...
                                            <div class="row no-gutters mb-2 border-bottom">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="group id" name="grp_id" class="c_input pl-2" readonly >
                                                </div>
                                            </div>
                                            <!--DESCRIPTION-->
                                            <div class="row no-gutters border-bottom">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="group descripion" class="c_input pl-2" name="grp_desc" required >
                                                </div>
                                            </div>
                                        </form>
                                        <?php endif; ?>
                ...
                <div class="card-body p-2">
                    ...
                    <form action="config/process/user_process.php" method="post" class='w-100'>
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" autocomplete="off" required placeholder="username"
                                name="username">
